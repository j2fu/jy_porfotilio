...
const aboutMeTextContent = "I am a Software Engineer & Data Analysist at UC San Diego. I major in Computer Science & Mathematics and minor in Data Science. Contact me!";
...
const resumeHideBtn = document.querySelector('.resume-hide-btn');

resumes.forEach((resume) => {
    resume.addEventListener("mouseenter", ()=>{
        resume.firstElementChild.style.top = `-${resume.
            firstElementChild.offsetHeight - resume.offsetHeight + 20}px`;
    });

    resume.addEventListener("mouseleave", ()=>{
        resume.firstElementChild.style.top = "1rem";
    });
    ...
    resume.addEventListener("click", () => {
        ...
        bigImgWrapper.className = "resume-img-wrapper";
        container.appendChild(bigImgWrapper);

        const bigImg = document.createElement("img");
        bigImg.className = "resume-img";
        bigImg.setAttribute("src", "images/projects/JY_resume.jpg");
        bigImgWrapper.appendChild(bigImg);
        document.body.style.overflowY = "hidden";

        resumeHideBtn.classList.add("change");
        resumeHideBtn.onclick = () =>{
            resumeHideBtn.classList.remove("change");
